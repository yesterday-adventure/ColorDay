...
public class GamePlayButton : MonoBehaviour
{
    ...
    void SettingWindowAppear()
    {
        ...
        panel.GetComponent<Image>().DOFade(0.4f, appearedTime);     // 어둡게 만들어주고
    ...
    void SettingWindowDisapear()
    {
        ...
        panel.GetComponent<Image>().DOFade(0, appearedTime);    // 어두웠던 것을 제거해주고
    ...
    public void ExitWindowAppear()  // 버튼을 누르면 익시트창이 나옴
    {
        ...
        SettingWindowDisapear();    // 익시트 창이 나와야 하니까
